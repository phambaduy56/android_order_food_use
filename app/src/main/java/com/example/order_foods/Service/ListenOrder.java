package com.example.order_foods.Service;
...
import com.example.order_foods.order_status_page;
...
public class ListenOrder extends Service implements ChildEventListener {
    ...
    private void showNotification(String key, Request request) {
        Intent intent=new Intent(getBaseContext(), order_status_page.class);
